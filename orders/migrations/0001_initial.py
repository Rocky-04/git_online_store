    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional_information', models.TextField(blank=True, max_length=300)),
                ...
                ('status',
                 models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='orders.status')),
            ],
            options={
                'verbose_name': 'Order',
